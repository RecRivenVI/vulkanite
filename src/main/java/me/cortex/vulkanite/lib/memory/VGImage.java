...
public class VGImage extends VImage {
    ...
    VGImage(VmaAllocator.ImageAllocation allocation, int dimensions, int width, int height, int depth, int mipLayers, int format, int glFormat, int glId) {
        super(allocation, dimensions, width, height, depth, mipLayers, format);
        this.glId = glId;
